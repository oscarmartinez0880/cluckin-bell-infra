...
# Route53 Outputs
output "apex_zone_id" {
  description = "Route53 zone ID for cluckn-bell.com"
  value       = module.apex_zone.zone_id
}

output "apex_zone_name_servers" {
  description = "Name servers for cluckn-bell.com"
  value       = module.apex_zone.name_servers
}

# ACM Outputs
output "prod_certificate_arn" {
  description = "ARN of the prod wildcard certificate"
  value       = module.prod_cert.certificate_arn
}
